  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="bg-gray-700 flex gap-5 p-10 items-center justify-end text-white py-4">
        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="bg-gray-500 h-8 w-24"></motion.div>
        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="bg-gray-500 h-8 w-24"></motion.div>
        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="bg-gray-500 h-8 w-24"></motion.div>
        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="bg-gray-500 h-8 w-24"></motion.div>
        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.9 }} className="bg-gray-500 h-8 w-24"></motion.div>
      ...
      <div className="flex flex-1">
        <div className="w-1/6 bg-gray-600 text-white">
          <div className="p-4">
            <motion.div whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} className="bg-gray-700 h-8 mb-4"></motion.div>
            <motion.div whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} className="bg-gray-700 h-8 mb-4"></motion.div>
        ...
        <div className="w-5/6 ">
          <div className="bg-gray-300 px-5 flex w-full m-auto justify-between center items-center">
            <motion.svg whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6">
            ...
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.99 }} className="bg-gray-400 w-1/2 mt-8 mb-20 h-80"></motion.div>
            <motion.svg whileHover={{ scale: 1.15 }} whileTap={{ scale: 0.95 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6">
          ...
          <div className="flex flex-wrap gap-2 justify-center items-center">
            {Array.from(Array(40)).map((_, index) => (
              <React.Fragment key={index}>
                <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className='flex flex-col mb-10 shadow'>
